...
import AdminAuthController from './controllers/admin/auth/adminAuth.controller';
import AdminUserService from './services/admin/user/adminUser.service';
import AdminUserController from './controllers/admin/user/adminUser.controller';
...
const googleAdminOAuth = new Google(
  config.googleAdmin.clientId,
  config.googleAdmin.clientSecret,
  config.googleAdmin.redirectUrl
);
...
const spotifyOAuth = new Spotify(
...
const randomDbdPerkService = new RandomDbdPerkService(
  randomDbdPerkRepository,
  userRepository,
  widgetService
);
const randomDBDKillerService = new RandomDBDKillerService(
...
const exportVideoService = new ExportVideoService(
  exportVideoRepository,
  userService,
  authService,
  widgetService,
  twitchGql
...
const spotifySongRequestService = new SpotifySongRequestService(
  spotifySongRequestRepository,
  userRepository,
  spotifyProvider,
  widgetService,
  authService
...
const clipShoutoutController = new ClipShoutoutController(
  clipShoutoutService,
  clipShoutoutEventController
);
...
const widgetTypeController = new WidgetTypeController(
...
// Event Layer
const twitchChannelChatMessageEvent = new TwitchChannelChatMessageEvent(
  firstWordService,
  dropImageService,
  spotifySongRequestService
);
...
const twitchChannelChatNotificationEvent = new TwitchChannelChatNotificationEvent(
  clipShoutoutService
);
const twitchChannelRedemptionAddEvent = new TwitchChannelRedemptionAddEvent(
  randomDbdPerkService,
  dropImageService,
  randomDBDKillerService
);
...
server.post(
  '/api/v1/admin/bulk-adjust-tier',
  adminController.bulkAdjustTierAndWidgets.bind(adminController)
);

server.get('/api/v1/admin/auth/google', adminAuthController.google.bind(adminAuthController));
server.get(
  '/api/v1/admin/auth/google/callback',
  adminAuthController.googleCallback.bind(adminAuthController)
);
...
server.get(
  '/api/v1/admin/users/:id/widgets',
  adminUserController.getWidgets.bind(adminUserController)
);
server.get(
...
server.put(
  '/api/v1/admin/widget-types/:id',
  widgetTypeController.update.bind(widgetTypeController)
);
server.delete(
  '/api/v1/admin/widget-types/:id',
  widgetTypeController.delete.bind(widgetTypeController)
);
server.post(
  '/api/v1/admin/widget-types/upload-icon',
  widgetTypeController.uploadIcon.bind(widgetTypeController)
);
...
server.post(
  '/api/v1/first-word/refresh-key',
  firstWordController.refreshKey.bind(firstWordController)
);
server.delete('/api/v1/first-word', firstWordController.delete.bind(firstWordController));
server.post(
  '/api/v1/first-word/chatters/reset',
  firstWordController.resetChatters.bind(firstWordController)
);
server.get(
  '/api/v1/first-word/chatters',
  firstWordController.listChatters.bind(firstWordController)
);

server.post(
  '/api/v1/first-word/custom-replies',
  firstWordController.createCustomReply.bind(firstWordController)
);
server.get(
  '/api/v1/first-word/custom-replies',
  firstWordController.listCustomReplies.bind(firstWordController)
);
server.put(
  '/api/v1/first-word/custom-replies/:id',
  firstWordController.updateCustomReply.bind(firstWordController)
);
server.delete(
  '/api/v1/first-word/custom-replies/:id',
  firstWordController.deleteCustomReply.bind(firstWordController)
);
...
server.post(
  '/api/v1/clip-shoutout/refresh-key',
  clipShoutoutController.refreshKey.bind(clipShoutoutController)
);

server.delete('/api/v1/clip-shoutout', clipShoutoutController.delete.bind(clipShoutoutController));

server.post(
  '/api/v1/random-dbd-perk',
  randomDbdPerkController.create.bind(randomDbdPerkController)
);
...
server.post(
  '/api/v1/random-dbd-perk/refresh-key',
  randomDbdPerkController.refreshKey.bind(randomDbdPerkController)
);
server.delete(
  '/api/v1/random-dbd-perk',
  randomDbdPerkController.delete.bind(randomDbdPerkController)
);

server.post(
  '/api/v1/random-dbd-killer',
  randomDBDKillerController.create.bind(randomDBDKillerController)
);
server.get(
  '/api/v1/random-dbd-killer',
  randomDBDKillerController.get.bind(randomDBDKillerController)
);
server.put(
  '/api/v1/random-dbd-killer',
  randomDBDKillerController.update.bind(randomDBDKillerController)
);
server.post(
  '/api/v1/random-dbd-killer/refresh-key',
  randomDBDKillerController.refreshKey.bind(randomDBDKillerController)
);
server.delete(
  '/api/v1/random-dbd-killer',
  randomDBDKillerController.delete.bind(randomDBDKillerController)
);

server.get(
  '/api/v1/dbd-killer-master',
  dbdKillerMasterController.list.bind(dbdKillerMasterController)
);
...
server.post(
  '/api/v1/drop-image/refresh-key',
  dropImageController.refreshKey.bind(dropImageController)
);
...
server.post(
  '/api/v1/end-credit/refresh-key',
  endCreditController.refreshKey.bind(endCreditController)
);
...
server.post(
  '/api/v1/spotify-song-request',
  spotifySongRequestController.create.bind(spotifySongRequestController)
);
server.get(
  '/api/v1/spotify-song-request',
  spotifySongRequestController.get.bind(spotifySongRequestController)
);
server.put(
  '/api/v1/spotify-song-request',
  spotifySongRequestController.update.bind(spotifySongRequestController)
);
server.delete(
  '/api/v1/spotify-song-request',
  spotifySongRequestController.delete.bind(spotifySongRequestController)
);
server.post(
  '/api/v1/spotify-song-request/test',
  spotifySongRequestController.test.bind(spotifySongRequestController)
);
...
server.post(
  '/api/v1/export-video/history',
  exportVideoController.createHistory.bind(exportVideoController)
);
server.get(
  '/api/v1/export-video/history',
  exportVideoController.listHistory.bind(exportVideoController)
);
server.get(
  '/api/v1/export-video/history/:historyId',
  exportVideoController.getHistory.bind(exportVideoController)
);
server.delete(
  '/api/v1/export-video/history/:historyId',
  exportVideoController.deleteHistory.bind(exportVideoController)
);
...
server.get(
  '/api/v1/widgets/first-enabled',
  widgetController.getFirstEnabled.bind(widgetController)
);
server.get('/api/v1/widgets/quota', widgetController.getQuota.bind(widgetController));
server.get(
  '/api/v1/widgets/validate-overlay/:key',
  widgetController.validateOverlayAccess.bind(widgetController)
);
...
server.get(
  '/api/v1/uploaded-files/total-size',
  uploadedFileController.getTotalFileSize.bind(uploadedFileController)
);
...
server.put(
  '/api/v1/uploaded-files/:id',
  uploadedFileController.update.bind(uploadedFileController)
);
server.delete(
  '/api/v1/uploaded-files/:id',
  uploadedFileController.delete.bind(uploadedFileController)
);

server.get(
  '/api/v1/twitch/channel-rewards',
  twitchController.listChannelRewards.bind(twitchController)
);
...
server.post(
  '/api/v1/twitch/export-videos',
  twitchGqlController.exportVideoToYoutube.bind(twitchGqlController)
);

server.get('/api/v1/linked-accounts', linkedAccountController.list.bind(linkedAccountController));
server.post(
  '/api/v1/linked-accounts/:platform/bind',
  linkedAccountController.bind.bind(linkedAccountController)
);
server.delete(
  '/api/v1/linked-accounts/:platform',
  linkedAccountController.unbind.bind(linkedAccountController)
);

server.register(FastifySSEPlugin);
server.get(
  '/api/v1/events/first-word/:userId',
  firstWordEventController.sse.bind(firstWordEventController)
);
server.get(
  '/api/v1/events/clip-shoutout/:userId',
  clipShoutoutEventController.sse.bind(clipShoutoutEventController)
);
server.get(
  '/api/v1/events/drop-image/:userId',
  dropImageEventController.sse.bind(dropImageEventController)
);
server.get(
  '/api/v1/events/random-dbd-killer/:userId',
  randomDBDKillerEventController.sse.bind(randomDBDKillerEventController)
);
server.get(
  '/api/v1/events/end-credit/:userId',
  endCreditEventController.sse.bind(endCreditEventController)
);
server.get(
  '/api/v1/end-credit/:userId/records',
  endCreditController.getRecords.bind(endCreditController)
);

server.post(
  '/webhook/v1/twitch/event-sub/channel-chat-message',
  twitchChannelChatMessageEvent.handle.bind(twitchChannelChatMessageEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/stream-online',
  twitchStreamOnlineEvent.handle.bind(twitchStreamOnlineEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/stream-offline',
  twitchStreamOfflineEvent.handle.bind(twitchStreamOfflineEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/channel-chat-notification',
  twitchChannelChatNotificationEvent.handle.bind(twitchChannelChatNotificationEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/channel-redemption-add',
  twitchChannelRedemptionAddEvent.handle.bind(twitchChannelRedemptionAddEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/channel-follow',
  twitchChannelFollowEvent.handle.bind(twitchChannelFollowEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/channel-subscribe',
  twitchChannelSubscribeEvent.handle.bind(twitchChannelSubscribeEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/channel-raid',
  twitchChannelRaidEvent.handle.bind(twitchChannelRaidEvent)
);
server.post(
  '/webhook/v1/twitch/event-sub/channel-bits-use',
  twitchChannelBitsUseEvent.handle.bind(twitchChannelBitsUseEvent)
);
