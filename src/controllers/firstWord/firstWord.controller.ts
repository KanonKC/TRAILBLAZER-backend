...
export default class FirstWordController {
    ...
    async get(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            const firstWord = await this.firstWordService.getByUserId(user.id, req.id);
    ...
    async update(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            const updated = await this.firstWordService.update(user.id, request, req.id);
    ...
    async create(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            const created = await this.firstWordService.create(request, req.id);
    ...
    async delete(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            await this.firstWordService.delete(user.id, req.id);
    ...
    async refreshKey(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            const updated = await this.firstWordService.refreshOverlayKey(user.id, req.id);
    ...
    async createCustomReply(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            await this.firstWordService.createCustomReply(user.id, result.data, req.id);
    ...
    async updateCustomReply(req: FastifyRequest<{ Params: { id: string } }>, res: FastifyReply) {
        ...
        try {
            ...
            await this.firstWordService.updateCustomReply(user.id, id, result.data, req.id);
    ...
    async deleteCustomReply(req: FastifyRequest<{ Params: { id: string } }>, res: FastifyReply) {
        ...
        try {
            await this.firstWordService.deleteCustomReply(user.id, id, req.id);
    ...
    async listCustomReplies(req: FastifyRequest<{ Querystring: { search?: string, page?: number, limit?: number } }>, res: FastifyReply) {
        ...
        try {
            ...
            const result = await this.firstWordService.listCustomReplies(user.id, { search }, { limit, page, total: 0 }, req.id);
    ...
    async resetChatters(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            await this.firstWordService.resetChatter(user.twitchId, req.id);
    ...
    async listChatters(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            const result = await this.firstWordService.listChatters(user.id, req.id);
