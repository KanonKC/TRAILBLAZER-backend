...
export default class WidgetController {
    ...
    async getFirstEnabled(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            const first = await this.widgetService.getFirstEnabled(req.id, user.id);
    ...
    async list(req: FastifyRequest<{
        ...
        try {
            ...
            const result = await this.widgetService.list(req.id, user.id, { page, limit }, { enabled });
    ...
    async update(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            const updated = await this.widgetService.update(req.id, id, user.id, request);
    ...
    async updateEnable(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            const updated = await this.widgetService.updateEnable(req.id, id, user.id, request.enabled);
    ...
    async validateOverlayAccess(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            const valid = await this.widgetService.validateOverlayAccess(req.id, user.id, key);
    ...
    async delete(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            ...
            await this.widgetService.delete(req.id, id, user.id);
    ...
    async getQuota(req: FastifyRequest, res: FastifyReply) {
        ...
        try {
            const quota = await this.widgetService.getQuota(req.id, user.id);
